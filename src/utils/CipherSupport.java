...
public class CipherSupport {
    ...
    public final static String[] SYMMETRIC_CIPHERS = new String[]{"AES", "DES", "TripleDES", "Blowfish", "RC2", "RC4"};
    public final static String[] SYMMETRIC_CIPHERS_THIRD_PARTY = new String[]{"ChaCha20", "SEED", "Camellia", "Serpent"};
